    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="border-emerald-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-emerald-600">{formatCurrency(mockBusinessAccount.balance)}</div>
            <p className="text-sm text-muted-foreground">{mockBusinessAccount.currency} Corporate Account</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-emerald-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(mockBusinessAccount.monthlyVolume)}</div>
        ...
        <Card className="border-emerald-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockBusinessAccount.employees}</div>
        ...
        <Card className="border-emerald-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{mockBusinessAccount.accountType}</div>
